...
global.reloadHandler = function () {
  ...
  conn.welcome = 'Hola 👋, @user!\nTedamos la bienvenida a: @subject\n\n@desc'
  conn.bye = '*Chao y te cuidas @user!👋 No vamos a extrañarte.* 😴 '
  conn.spromote = '@user Felicidaes, ahora eres admin!'
  conn.sdemote = '@user Lo siento, ya no eres admin!'
...
_quickTest()
  .then(() => conn.logger.info('Testeo inicial completado con exito.'))
  .catch(console.error)